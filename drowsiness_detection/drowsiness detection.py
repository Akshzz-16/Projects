...
mixer.init()
sound = mixer.Sound('C:/Users/akash/IMP-FILES/python-coding/deployed_projects/drowsiness_detection/alarm.wav')
...
model = load_model('C:/Users/akash/IMP-FILES/python-coding/deployed_projects/drowsiness_detection/models/cnnCat2.h5')
path = os.getcwd()
